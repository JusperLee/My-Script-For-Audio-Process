'''
@Author: Kai Li
@Date: 2020-07-22 02:43:13
@LastEditors: Kai Li
@LastEditTime: 2020-07-30 18:23:03
@FilePath: /Conv_TasNet_asteroid/utils/get_training_stat.py
'''
"""
...
WHAM_ROOT = "/home/likai/data3/WHAM/noise_data/wav8k"
...
for mode in ["min"]:
    for split in ["tr"]:
        ...
        plt.savefig('train_stat.png', dpi=1000)